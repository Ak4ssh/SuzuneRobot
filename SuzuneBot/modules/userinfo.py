...
from SuzuneBot.__main__ import STATS, TOKEN, USER_INFO
import SuzuneBot.modules.sql.userinfo_sql as sql
from SuzuneBot.modules.disable import DisableAbleCommandHandler
from SuzuneBot.modules.sql.global_bans_sql import is_user_gbanned
from SuzuneBot.modules.sql.afk_sql import is_afk, check_afk_status
from SuzuneBot.modules.sql.users_sql import get_user_num_chats
from SuzuneBot.modules.helper_funcs.chat_status import sudo_plus
from SuzuneBot.modules.helper_funcs.extraction import extract_user
from SuzuneBot import telethn as SuzuneBotTelethonClient, TIGERS, DRAGONS, DEMONS
...
def info(update: Update, context: CallbackContext):
    ...
    if user.id == OWNER_ID:
        text += "\n\n𝐍ᴇᴠᴇʀ 𝐌ᴇss 𝐖ɪᴛʜ 𝐌ʏ 𝐆ᴏᴅ."
        disaster_level_present = True
    elif user.id in DEV_USERS:
        text += "\n\n𝐓ʜɪs 𝐌ᴇᴍʙᴇʀ 𝐈s 𝐀 '𝐃ᴇᴠ' 𝐓ʜᴇ 𝐒ᴇᴄᴏɴᴅ 𝐌ᴏsᴛ 𝐏ᴏᴡᴇʀғᴜʟʟ 𝐔sᴇʀ 𝐎ғ 𝐁ᴏᴛ'."
        disaster_level_present = True
    elif user.id in DRAGONS:
        text += "\n\n𝐎ʜʜ 𝐒ʜɪᴛ 𝐀 𝐃ʀᴀɢᴏɴ 𝐔sᴇʀ 𝐀ʀʀɪᴠᴇᴅ."
        disaster_level_present = True
    elif user.id in DEMONS:
        text += "\n\n'𝐎ʜʜ 𝐒ʜɪᴛ 𝐀 𝐃ᴇᴍᴏɴ 𝐔sᴇʀ 𝐀ʀʀɪᴠᴇᴅ."
        disaster_level_present = True
    elif user.id in TIGERS:
        text += "\n\n𝐎ʜʜ 𝐒ʜɪᴛ 𝐀 𝐓ɪɢᴇʀ 𝐔sᴇʀ 𝐀ʀʀɪᴠᴇᴅ."
        disaster_level_present = True
    elif user.id in WOLVES:
        text += "\n\n𝐎ʜʜ 𝐒ʜɪᴛ 𝐀 𝐖ᴏʟᴠᴇs 𝐔sᴇʀ 𝐀ʀʀɪᴠᴇᴅ."
        disaster_level_present = True

    if disaster_level_present:
        text += ' [<a href="..">☆</a>]'.format(bot.username)
...
def stats(update: Update, context: CallbackContext):
    stats = "<b>🇮🇳 𝐍ᴇᴡ 𝐒ᴛᴀᴛs 𝐎ғ 𝐒ᴜᴢᴜɴᴇ 𝐇ᴏʀɪᴋɪᴛᴀ 🥀</b>\n" + "\n".join([mod.__stats__() for mod in STATS])
...
def set_about_bio(update: Update, context: CallbackContext):
    ...
    if message.reply_to_message:
        ...
        if user_id == bot.id and sender_id not in DEV_USERS:
            message.reply_text("Erm... yeah, I only trust 𝐒ᴜᴢᴜɴᴇ 𝐇ᴏʀɪᴋɪᴛᴀ to set my bio.")
            return
...
STATS_HANDLER = CommandHandler("newstats", stats)
